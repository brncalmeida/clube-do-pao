...
/**
 * Tratamento de erro caso o client digite uma barra "/" ao final da url, baixado do vraptor.caelum.br/cookbook.
 * 
...
public class Error404 extends DefaultResourceNotFoundHandler {
	...
	/**
	 * tratar URI, interpreta "site.com/uri" igual a "site.com/uti/"
	 */
	@Override
